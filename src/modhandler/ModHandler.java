...
public class ModHandler
{
	...
	public void getMod(String json)
	{
		...
		try
		{
			...
			this.modList.add(new Mod(Math.toIntExact((long) jsonObject.get("id")), (String) jsonObject.get("url"), categories, (String) jsonObject.get("author"), (String) jsonObject.get("contact"), (String) jsonObject.get("title"), (String) jsonObject.get("name"), (String) jsonObject.get("description"), (String) jsonObject.get("homepage"), mR) );
		}
